package pt.ipb.dsys.assessment.four.app3.service;
...
public class App3Service {
    private static final Logger logger = LoggerFactory.getLogger(App3Service.class);
    ...
    public App3Service(JmsTemplate jmsTemplate, ObjectMapper objectMapper, UpdateService updateService) {
    ...
    @JmsListener(destination = "queue-3")
