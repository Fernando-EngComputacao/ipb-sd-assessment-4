package pt.ipb.dsys.assessment.four.app4.service;
...
public class App4Service {
    private static final Logger logger = LoggerFactory.getLogger(App4Service.class);
    ...
    public App4Service(JmsTemplate jmsTemplate, ObjectMapper objectMapper, UpdateService updateService) {
    ...
    @JmsListener(destination = "queue-4")
