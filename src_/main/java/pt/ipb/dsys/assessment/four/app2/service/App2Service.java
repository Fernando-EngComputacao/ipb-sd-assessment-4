package pt.ipb.dsys.assessment.four.app2.service;
...
public class App2Service {
    ...
    public App2Service(JmsTemplate jmsTemplate, ObjectMapper objectMapper, UpdateService updateService) {
